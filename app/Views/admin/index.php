             ...
             <div class="card">
                ...
                <div class="card-body mt-2 mb-1">
                  <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder mt-2">
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="50" src="<?= base_url(); ?>/assets/img/users/user-5.png">
                    ...
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="50" src="<?= base_url(); ?>/assets/img/users/user-4.png">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="50" src="<?= base_url(); ?>/assets/img/users/user-1.png">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="50" src="<?= base_url(); ?>/assets/img/users/user-3.png">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="50" src="<?= base_url(); ?>/assets/img/users/user-2.png">
                      <div class="media-body">
              ...
              <div class="card author-box">
                  ...
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="<?= base_url(); ?>/assets/img/logo.png" class="author-box-picture">
